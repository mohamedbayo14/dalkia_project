...
<div class="container ">
    ...
    <br/>
       ...
       <br />
        <form method="POST" action="traitement_telecharger.php">
            <h2 id="contactForm">Page de téléchargement</h2>
            <fieldset>
                <br>
            ...
            <br>
            <center><p> <button class="btn btn-primary " type="submit" name="telecharger">télécharger données mensuelles</button> </p></center>
        </form>
    <form method="POST" action="traitement_telecharger_annuelle.php">
            <fieldset>
                <br>
                <div class="form-group">
                    <div class="form-row">
            ...
            <br>
            <center><p> <button class="btn btn-primary " type="submit" name="telecharger">télécharger données annuelles</button> </p></center>
